...
export default class EmailService {
  ...
  constructor() {
    this.route = `${process.env.PAGE_URL}`;
  ...
  async sendConfirmEmail(
    ...
    const confirmURL = `${this.route}email-confirmation?c=${confToken}`; // this will be our route
  ...
  async sendResetEmail(
    ...
    const resetURL = `${this.route}password-reset?r=${confToken}`;
